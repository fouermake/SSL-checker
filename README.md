Программа предназначена для проверки SSL-сертификатов на доменах, что позволяет узнать, действителен ли сертификат и когда он истекает. Результаты проверки можно сохранить в файлах форматов .xlsx или .txt. 
